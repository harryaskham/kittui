        ...
        while stdin_ready(Duration::ZERO) {
            ...
            for action in input_parser.actions(&buf[..n]) {
                match action {
                    ...
                    BrowserInputAction::ShiftBackspace => browser.send_shift_backspace()?,
                    BrowserInputAction::CtrlBackspace => browser.send_ctrl_backspace()?,
                    BrowserInputAction::AltBackspace => browser.send_alt_backspace()?,
                    BrowserInputAction::Tab => browser.send_tab()?,
                    BrowserInputAction::ShiftTab => browser.send_shift_tab()?,
                    BrowserInputAction::CtrlTab => browser.send_ctrl_tab()?,
                    ...
                    BrowserInputAction::AltEnter => browser.send_alt_enter()?,
...
fn browser_csi_input_action(bytes: &[u8]) -> (Option<BrowserInputAction>, usize) {
    ...
    let action = match sequence {
        ...
        [b'9', b';', b'5', b'u'] => Some(BrowserInputAction::CtrlTab),
        [b'8', b';', b'2', b'u'] | [b'1', b'2', b'7', b';', b'2', b'u'] => {
            Some(BrowserInputAction::ShiftBackspace)
        }
        [b'8', b';', b'5', b'u'] | [b'1', b'2', b'7', b';', b'5', b'u'] => {
            Some(BrowserInputAction::CtrlBackspace)
        }
        [b'8', b';', b'3', b'u'] | [b'1', b'2', b'7', b';', b'3', b'u'] => {
            Some(BrowserInputAction::AltBackspace)
        }
        [b'1', b'3', b';', b'2', b'u'] => Some(BrowserInputAction::ShiftEnter),
        [b'1', b'3', b';', b'5', b'u'] => Some(BrowserInputAction::CtrlEnter),
        [b'1', b'3', b';', b'3', b'u'] => Some(BrowserInputAction::AltEnter),
        ...
        [b'2', b'0', b'~'] => Some(BrowserInputAction::Function(BrowserFunctionKey::F9)),
        [b'2', b'1', b'~'] => Some(BrowserInputAction::Function(BrowserFunctionKey::F10)),
        [b'2', b'3', b'~'] => Some(BrowserInputAction::Function(BrowserFunctionKey::F11)),
        [b'2', b'4', b'~'] => Some(BrowserInputAction::Function(BrowserFunctionKey::F12)),
    ...
    fn browser_input_actions_preserve_text_backspace_tab_enter_page_and_arrow_order() {
        assert_eq!(
            ...
            vec![
                ...
                BrowserInputAction::Function(BrowserFunctionKey::F9),
                BrowserInputAction::Function(BrowserFunctionKey::F10),
                BrowserInputAction::Function(BrowserFunctionKey::F11),
                BrowserInputAction::Function(BrowserFunctionKey::F12),
