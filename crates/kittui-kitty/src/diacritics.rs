/// Row/column placeholder diacritic codepoints from the kitty graphics protocol.
/// Source: https://sw.kovidgoyal.net/kitty/graphics-protocol/#unicode-placeholders
/// (rowcolumn-diacritics.txt, 297 entries; 1-indexed in the spec).
pub(crate) const ROWCOLUMN_DIACRITICS: &[char] = &[
...
pub(crate) const ROWCOLUMN_DIACRITICS_COUNT: usize = 297;
