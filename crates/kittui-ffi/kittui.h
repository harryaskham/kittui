...
/* Render+place a JSON array of scenes at a runtime group origin. */
KittuiStatus kittui_place_many_json_at(KittuiRuntime* runtime,
                                       const char* scenes_json,
                                       uint16_t x,
                                       uint16_t y,
                                       char** out);
...
/* Render a JSON array of scenes and return a channelized JSON manifest. */
KittuiStatus kittui_render_many_json(KittuiRuntime* runtime,
                                     const char* scenes_json,
                                     char** out);
