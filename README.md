...
- `kittwm` with no backend flags starts a native PTY terminal sized to the host terminal; `Ctrl-A %` creates another shell pane, `Ctrl-A Tab` cycles focus, and `Ctrl-A x` closes the focused pane.
